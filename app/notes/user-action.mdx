...
> X: I actually just thought this could be a solution for an issue I had where I needed to fill 10s of fields with a lot of stuff happening on user interactions, and I saw myself writing multiple "fillForms" helpers to get the form to the state i wanted to test some specific behavior
